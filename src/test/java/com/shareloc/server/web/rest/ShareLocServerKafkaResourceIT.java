...
public class ShareLocServerKafkaResourceIT {
    ...
    @Autowired
    private ShareLocServerKafkaProducer producer;

    @Autowired
    private ShareLocServerKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        ShareLocServerKafkaResource kafkaResource = new ShareLocServerKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/share-loc-server-kafka/publish?message=test"))
